...
const sidebar = (data) => {
  ...
  sidebar__paramtr_1.innerHTML = `
      <div class="sidebar__paramtr-1__text" data-bs-toggle="collapse" data-bs-target="#collapse" aria-expanded="true" aria-controls="collapse">
        <h4>${param1}</h4>
      </div>
      <ul class="collapse${param1}" id="collapse">
        ${
    ...
    <ul class="collapse${param2}" id="collapse${param2}">
      ${
